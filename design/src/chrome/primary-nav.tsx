 ...
 *
 *   - Active-link affordance is text-only: the active item is rendered in
 *     `text-primary` (orange) against `text-muted-foreground` siblings. No
 *     underline / bottom stripe — kept deliberately restrained.
 *
